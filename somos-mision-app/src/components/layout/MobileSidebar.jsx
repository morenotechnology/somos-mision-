...
import { X, LayoutDashboard, BookOpen, Trophy, Target, User, Settings, Globe, Zap } from 'lucide-react';
          ...
          >
            ...
            <div className="flex items-center justify-between px-5 py-5 border-b border-white/10">
              <div className="flex items-center gap-3">
                <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-[#D4AF37] to-[#F5E27A] flex items-center justify-center">
